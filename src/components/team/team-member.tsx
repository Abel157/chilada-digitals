...
const TeamMember = () => {
  ...
  return (
    <motion.div
      ...
      <div
        className='overflow-hidden h-[450px] w-[350px] rounded-2xl hover:shadow-lg transition duration-300 ease-in-out'
      >
        <Image
          src={teamMember}
          alt='Team Member'
      ...
      <div
        ...
        className='absolute bg-opacity-10 top-64 left-2 rounded-2xl p-4 z-10 transition duration-300 ease-in-out'
      >
        <h3
          style={{
            color: 'white',
      ...
      <div
        className='absolute top-0 left-0 w-full h-full bg-black opacity-50 rounded-2xl transition duration-300 ease-in-out hover:opacity-20'
      ></div>
    </motion.div>
  )
}
